<template>
    <div class="flex justify-between pt-12 px-3">
        <div class="w-5/12 ml-3 md:ml-0 bg-white border border-gray-400 rounded-lg md:rounded-xl p-3 md:px-8 md:py-6 group">
        ...
        <div class="w-5/12 mr-3 md:mr-0 bg-white border border-gray-400 rounded-lg md:rounded-xl p-3 md:px-8 md:py-6 group">
